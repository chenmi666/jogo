export const bichoStates = [
  ...
  { label: "Pernambuco", href: "/pernambuco/" },
  { label: "Rio de Janeiro", href: "/rio-de-janeiro/" },
...
export const caixaLoterias = [
  { label: "Mega Sena", href: "/mega-sena/" },
  { label: "Lotofácil", href: "/lotofacil/" },
  { label: "Mais Milionária", href: "/mais-milionaria/" },
...
export const footerLinks = [
  ...
  { label: "Palpites Deu no Poste", href: "/palpites-jogo-do-bicho/" },
]
